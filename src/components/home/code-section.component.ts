  ...
  render(): string {
    return HTML`
          <div>
            ...
            <section class="h-screen py-20 flex items-center rounded-b-[2rem] bg-gradient-to-br from-[#ffffff] via-[#9333EA] to-[#6b007e] justify-center">
                <img src="/images/code-snippet-1.png" alt="dot-ui-bg" class="opacity-85  max-w-4xl max-h-[530px] w-full h-full" />
             </section>
            ...
            <div>
               ...
               <section class=" bg-gradient-to-r  from-purple-500 to-purple-900 w-full grid md:grid-cols-2 justify-items-center place-items-center px-20 py-20 gap-24 rounded-t-[2rem]  rounded-b-[2rem]">
                <img src="/images/code-snippet-2.png" alt="dot-ui-bg" class="opacity-90 max-w-5xl max-h-[630px] rounded-lg w-full h-full shadow-lg sm:-rotate-12" />
                <img src="/images/code-snippet-3.png" alt="dot-ui-bg" class="max-w-2xl rounded-lg max-h-[630px] w-full shadow-2xl sm:rotate-12" />
               </section>
            </div>
          <div/>
        `;
