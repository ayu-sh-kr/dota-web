    ...
    render(): string {
        ...
        <div class="flex flex-col justify-center items-center h-screen font-dm gap-y-6">
           <svg rpl="" fill="#dadada" height="60" icon-name="meme-fill" viewBox="0 0 20 20" width="60" xmlns="http://www.w3.org/2000/svg">
            ...
            <p class="text-lg font-medium dark:text-gray-200">The document you're looking for doesn't exist or has been moved to another location.</p>
           <div class="items-center flex gap-2">
                ...
                <source src="https://cdnl.iconscout.com/lottie/premium/preview-watermark/error-404-14393877-11613454.mp4" type="video/mp4">
           
                 <a href="/docs" class="bg-gray-200 dark:bg-slate-800 dark:text-white px-5 py-3 rounded-lg flex items-center gap-1">
                      <svg xmlns="http://www.w3.org/2000/svg" width="32" height="24" viewBox="0 0 24 24">
                <path fill="currentColor" d="M8.385 12.308h7.23v-1h-7.23zm0 2.769h7.23v-1h-7.23zm0 2.77h4.23v-1h-4.23zM5 21V3h9.5L19 7.5V21zm9-13V4H6v16h12V8zM6 4v4zv16z"/>
                </svg>
                    Documentation   
                </a>
            </div>
